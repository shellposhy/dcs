$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href',appPath+'/admin/css/bootstrap-'+theme_name+'.css');
	}
...
function docReady(){
	...
	//复选单选
	$("input:checkbox, input:radio").not('[data-no-uniform="true"],.no_uniform input, #uniform-is-ajax, .ui-multiselect-menu input').each(function(){
	...
	//选择 下拉列表
	$('[data-rel="chosen"],[rel="chosen"]').chosen({no_results_text: "没有匹配结果"});
...
//日期选择汉化
   ...
   function timepickerReady(){
  	  $(".timepicker").click(function(){
  	  	$("div.content_wrap").css("z-index",1);
  	  })
